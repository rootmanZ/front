  ...
  <div>
    <div class="search-con">
      ...
      <Select v-model="listQuery.actId" clearable placeholder="活动名称" style="width: 200px">
        <Option v-for="item in actList" :value="item.actId" :key="item.actId">{{ item.actName }}</Option>
      </Select>
      <Select v-model="listQuery.prizeId" clearable placeholder="奖品名称" style="width: 200px">
        <Option v-for="item in prizeList" :value="item.prizeId" :key="item.prizeId">{{ item.prizeName }}</Option>
      </Select>
