    ...
    data() {
      ...
      return {
        ...
        rulesActivity: {
          ...
          'actConfigExpress.actNumberConfig.shareAddNum': [
            {required: true, message: '必填项'},
            {validator: validateIntData}
          ],
          'actConfigExpress.actNumberConfig.dailyShareAddLimit': [
            {validator: validateIntData}
          ],
          'actConfigExpress.actNumberConfig.payAddNum': [
            {validator: validateIntData}
          ],
          'actConfigExpress.actNumberConfig.dailyPayAddLimit': [
            {validator: validateIntData}
          ],
